...
def count_negations_dataset(path_to_dev_file, path_to_train_file):
    """
...
plot_distribution_pos_alltokens(count_train, 'count_pos_train')
plot_distribution_pos_alltokens(count_dev, 'count_pos_dev')

count_negations_dataset(inputfile_dev, inputfile_train, 'distribution_negation_postags')
