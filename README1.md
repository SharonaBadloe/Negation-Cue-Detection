...
# Project Description:
This project focusses on negation cue detection. A task where negation cues (e.g., words or affixes) are detected 
based on our own build classifier. For more information about related work and our features, see the report.
